...
COUNTRY_SOURCES = \
    default('CITIES_LIGHT_COUNTRY_SOURCES', ['http://download.geonames.org/export/dump/countryInfo.txt'])
REGION_SOURCES = \
    default('CITIES_LIGHT_REGION_SOURCES', ['http://download.geonames.org/export/dump/admin1CodesASCII.txt'])
CITY_SOURCES = \
    default('CITIES_LIGHT_CITY_SOURCES', ['http://download.geonames.org/export/dump/cities15000.zip'])
TRANSLATION_SOURCES = \
    default('CITIES_LIGHT_TRANSLATION_SOURCES', ['http://download.geonames.org/export/dump/alternateNames.zip'])
TRANSLATION_LANGUAGES = \
    default('CITIES_LIGHT_TRANSLATION_LANGUAGES', ['es', 'en', 'pt', 'de', 'pl', 'abbr'])
...
ISO3166_TO_ISO639 = default('CITIES_LIGHT_ISO3166_TO_ISO639', DEFAULT_ISO3166_TO_ISO639)
