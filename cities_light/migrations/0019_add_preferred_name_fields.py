...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cities_light_country', 'preferred_name',
        ...
        db.add_column(u'cities_light_city', 'preferred_name',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Region.preferred_name'
        db.add_column(u'cities_light_region', 'preferred_name',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=200, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'cities_light_country', 'preferred_name')

        # Deleting field 'City.preferred_name'
        db.delete_column(u'cities_light_city', 'preferred_name')

        # Deleting field 'Region.preferred_name'
        db.delete_column(u'cities_light_region', 'preferred_name')
