...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Country.preferred_name'
        db.add_column(u'django_geonames_country', 'preferred_name',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'City.preferred_name'
        db.add_column(u'django_geonames_city', 'preferred_name',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Region.preferred_name'
        db.add_column(u'django_geonames_region', 'preferred_name',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Country.preferred_name'
        db.delete_column(u'django_geonames_country', 'preferred_name')

        # Deleting field 'City.preferred_name'
        db.delete_column(u'django_geonames_city', 'preferred_name')

        # Deleting field 'Region.preferred_name'
        db.delete_column(u'django_geonames_region', 'preferred_name')
