...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('django_geonames_city', 'display_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Region.display_name'
        db.add_column('django_geonames_region', 'display_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('django_geonames_city', 'display_name')

        # Deleting field 'Region.display_name'
        db.delete_column('django_geonames_region', 'display_name')
