...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Country.update_preferred_name'
        db.add_column(u'django_geonames_country', 'update_preferred_name',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Region.update_preferred_name'
        db.add_column(u'django_geonames_region', 'update_preferred_name',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'City.update_preferred_name'
        db.add_column(u'django_geonames_city', 'update_preferred_name',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Country.update_preferred_name'
        db.delete_column(u'django_geonames_country', 'update_preferred_name')

        # Deleting field 'Region.update_preferred_name'
        db.delete_column(u'django_geonames_region', 'update_preferred_name')

        # Deleting field 'City.update_preferred_name'
        db.delete_column(u'django_geonames_city', 'update_preferred_name')
