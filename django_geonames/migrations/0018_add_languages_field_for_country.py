...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Country.languages'
        db.add_column(u'django_geonames_country', 'languages',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Country.languages'
        db.delete_column(u'django_geonames_country', 'languages')
