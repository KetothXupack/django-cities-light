...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'django_geonames_city', 'search_names')


    def backwards(self, orm):
        # Adding field 'City.search_names'
        db.add_column(u'django_geonames_city', 'search_names',
                      self.gf('django_geonames.models.ToSearchTextField')(default='', max_length=4000, blank=True, db_index=True),
                      keep_default=False)
