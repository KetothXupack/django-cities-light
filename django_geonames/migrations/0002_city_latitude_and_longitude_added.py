...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('django_geonames_city', 'latitude',
        ...
        db.add_column('django_geonames_city', 'longitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=5, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('django_geonames_city', 'latitude')

        # Deleting field 'City.longitude'
        db.delete_column('django_geonames_city', 'longitude')
