...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'django_geonames_country', 'population',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'City.population'
        db.add_column(u'django_geonames_city', 'population',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'django_geonames_country', 'population')

        # Deleting field 'City.population'
        db.delete_column(u'django_geonames_city', 'population')
