...
from django_geonames.settings import INDEX_SEARCH_NAMES
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('django_geonames_city', 'search_names', self.gf('django.db.models.fields.TextField')(default='', max_length=4000, db_index=INDEX_SEARCH_NAMES, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'City.search_names'
        db.delete_column('django_geonames_city', 'search_names')
