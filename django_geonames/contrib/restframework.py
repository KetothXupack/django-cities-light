"""
Couple djangorestframework and django_geonames.

It defines a urlpatterns variables, with the following urls:

- django_geonames_api_city_list
- django_geonames_api_city_detail
- django_geonames_api_region_list
- django_geonames_api_region_detail
- django_geonames_api_country_list
- django_geonames_api_country_detail

If djangorestframework is installed, all you have to do is add this url
include::

    url(r'^django_geonames/api/', include('django_geonames.contrib.restframework')),
...
class CityResource(ModelResource):
    ...
    def region(self, instance):
        ...
        if instance.region_id:
            return urlresolvers.reverse('django_geonames_api_region_detail',
    ...
    def country(self, instance):
        ...
        """
        return urlresolvers.reverse('django_geonames_api_country_detail',
